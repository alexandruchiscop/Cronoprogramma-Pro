...
* **Pianificazione Diretta (Forward):** Calcola la data di fine lavori partendo dalla data di inizio e dalla durata in giorni lavorativi.
* **Retro-Planning (Backward):** Determina i giorni lavorativi disponibili data una scadenza improrogabile.

## Gestione Calendario e Sospensioni

L'algoritmo di calcolo integra filtri personalizzabili per riflettere le reali condizioni operative:

* **Sospensioni Feriali:** Possibilità di inserire multipli intervalli di date (es. chiusure estive o natalizie) da escludere dal conteggio.
* **Santo Patrono:** Modulo specifico per la festività locale, con validazione automatica dei campi mese/giorno.
* **Weekend:** Gestione flessibile del sabato (lavorativo o non lavorativo).
